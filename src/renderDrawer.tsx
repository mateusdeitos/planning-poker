...
export const DrawerContainer = ({
	children,
	...props
}: PropsWithChildren<TDrawerComponent<unknown>>) => {
	return (
		<Drawer {...props}>
			<DrawerOverlay />
			{children}
...
export const renderDrawer = <T extends unknown = any>(
	Component: React.FC<TDrawerComponent<any>>
) => {
	...
	return new Promise<T>((resolve, _reject) => {
		const Provider = () => {
			...
			return (
				<DrawerContext.Provider value={{ close, reject }}>
